...
class MenuCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Material(
        color: page.color,
        borderRadius: BorderRadius.circular(10), // Ensure this matches the Card's border radius
        child: InkWell(
          ...
          borderRadius: BorderRadius.circular(10), // Match with Material's border radius
          child: Container(
